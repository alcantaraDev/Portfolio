...
export function OutlineSimbol({width, height, strokeWidth}:outlineProps) {
    return (
        <svg strokeWidth={strokeWidth} width={width} height={height} viewBox="0 0 77 52" fill="none" xmlns="http://www.w3.org/2000/svg">
